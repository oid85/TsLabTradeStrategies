...
// Фильтр отсутствует
// 
// Выход - трейлинг по противоположной границе канала
//
...
namespace Centaur.Strategies.VolatilityBreakout.VolatilityBreakoutClassic
{
    public class VolatilityBreakoutClassic_FixLot : IExternalScript
    {
